...
function _Check(objRequest) {
  nlapiLogExecution('AUDIT',"CHECK Attestation", "=====START=====");
  ...
  if (arrQuestionResults && arrQuestionResults.length && objRxData.AppId) {
    ...
    nlapiLogExecution('AUDIT',"CHECK Attestation", "ArrAnswers: " + JSON.stringify(arrAnswers));
  ...
  nlapiLogExecution('AUDIT',"CHECK Attestation", "======END======");
  return (JSON.stringify(objDataResponse));
}

function _Create(objRequest) {
  nlapiLogExecution('AUDIT',"CREATE Attestation", "=====START=====");
  ...
  nlapiLogExecution('AUDIT',"CREATE Attestation", "======END======");
  return (JSON.stringify(objDataResponse));
}

function _CreateAll(objRequest) {
  // nlapiLogExecution('AUDIT',"CreateAll Attestation", "=====START=====");
  ...
  // nlapiLogExecution('AUDIT',"CreateAll Attestation", "======END======");
  return (JSON.stringify(objDataResponse));
}

function _Delete(objRequest) {
  nlapiLogExecution('AUDIT',"DELETE Attestation", "=====START=====");
  ...
  nlapiLogExecution('AUDIT',"DELETE Attestation", "======END======");
  return (JSON.stringify(objDataResponse));
}

function _Delete_All(objRequest) {
  // nlapiLogExecution('AUDIT',"DELETE_ALL Attestation", "=====START=====");
  ...
  // nlapiLogExecution('AUDIT',"DELETE_ALL Attestation", "======END======");
  return (JSON.stringify(objDataResponse));
}

function _ReadQuestion(objRequest) {
  nlapiLogExecution('AUDIT',"ReadQuestion Attestation", "=====START=====");
  ...
  nlapiLogExecution('AUDIT',"READ Question", "======END======");
  return (JSON.stringify(objDataResponse));
}

function _ReadAnswer(objRequest) {
  // nlapiLogExecution('AUDIT',"ReadAnswer Attestation", "=====START=====");
  ...
  // nlapiLogExecution('AUDIT',"READ Attestation", "======END======");
  return (JSON.stringify(objDataResponse));
}

function _Update(objRequest) {
  // nlapiLogExecution('AUDIT',"UPDATE Attestation", "=====START=====");
  ...
  // nlapiLogExecution('AUDIT',"UPDATE Attestation", "======END======");
  return (JSON.stringify(objDataResponse));
