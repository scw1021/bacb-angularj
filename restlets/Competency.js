...
function _GetSkillList(objRequest) {
...
function _Check(objRequest) {
  nlapiLogExecution('AUDIT','CHECK Competency.ss', '=====START=====');
  ...
  nlapiLogExecution('AUDIT','CHECK Competency', '======END======');
  return (JSON.stringify(objDataResponse));
};

function _Create(objRequest) {
  nlapiLogExecution('AUDIT','CREATE Competency', '=====START=====');
  ...
  nlapiLogExecution('AUDIT','CREATE Competency', '======END======');
  return (JSON.stringify(objDataResponse));
};

function _Read(objRequest) {
  nlapiLogExecution('AUDIT','READ Competency', '=====START=====');
  ...
  nlapiLogExecution('AUDIT','READ Competency', '======END======');
  return (JSON.stringify(objDataResponse));
};

function _Update(objRequest) {
  nlapiLogExecution('AUDIT','UPDATE Competency', '=====START=====');
