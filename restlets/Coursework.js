...
nlapiLogExecution('AUDIT',"SUBMIT Coursework", "======END======");
return (JSON.stringify(objDataResponse));
}

function _Check(objRequest) {
nlapiLogExecution('AUDIT','CHECK Coursework', '=====START=====');
// var stCustId = objRequest['CustomerId'];
var objRxData = objRequest;
...
nlapiLogExecution('AUDIT','CHECK Coursework', '======END======');
  return (JSON.stringify(objDataResponse));
};

function _Create(objRequest) {
  nlapiLogExecution('AUDIT','Coursework CREATE', '=====START=====');
  ...
  nlapiLogExecution('AUDIT','Coursework CREATE', '======END======');
  return (JSON.stringify(objDataResponse));
}

function _Delete(objRequest) {
  nlapiLogExecution('AUDIT','Coursework DELETE', '=====START=====');
...
nlapiLogExecution('AUDIT','Coursework DELETE', '======END======');
  return (JSON.stringify(objDataResponse));
};

function _Delete_All(objRequest) {
  nlapiLogExecution('AUDIT','Coursework DELETE_ALL', '=====START=====');
  ...
  nlapiLogExecution('AUDIT','Coursework DELETE_ALL', '======END======');
  return (JSON.stringify(objDataResponse));
};

function _Read(objRequest) {
  nlapiLogExecution('AUDIT','Coursework READ', '=====START=====');
  ...
  nlapiLogExecution('AUDIT','Coursework READ', '======END======');
  return (JSON.stringify(objDataResponse));
};

function _Update(objRequest) {
  nlapiLogExecution('AUDIT','Coursework UPDATE', '=====START=====');
  ...
  nlapiLogExecution('AUDIT','UPDATE Coursework', '======END======');
  return (JSON.stringify(objDataResponse));
};
