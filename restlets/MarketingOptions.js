...
function _GetMarketingOptions(objRequest) {
  try {
  ...
  return (JSON.stringify(marketingOptions));
}


function _GetUsersOptedInMarketingOptions(objRequest) {
 ...
 * @param objResponse
 */
function _UpdateUserOptedInMarketingOptions(objRequest) {
