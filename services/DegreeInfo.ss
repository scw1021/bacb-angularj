...
E$.logAudit('CHECK DegreeInfo', '=====START=====');
  ...
  try {
    ...
    nlapiLogExecution('ERROR', 'Check DegreeInfo', 'The call to get the current web session failed.:' + ex.message)
  }
  ...
  if (stBody) {
    ...
    nlapiLogExecution('ERROR', 'Check DegreeInfo', 'Body of the request is not defined.');
  }
  ...
  E$.logAudit('CHECK DegreeInfo', '======END======');
	objResponse.setContentType('PLAINTEXT');
	objResponse.write(JSON.stringify(objDataResponse));
};

function _Create(objRequest, objResponse) {
    E$.logAudit('CREATE DegreeInfo', '=====START=====');
    ...
    try {
        ...
        nlapiLogExecution('ERROR', 'Create DegreeInfo', 'The call to get the current web session failed.:' + ex.message)
    }
	...
	if (stBody) {
        ...
        nlapiLogExecution('ERROR', 'Create DegreeInfo', 'Body of the request is not defined.');
    }
    ...
    E$.logAudit('CREATE DegreeInfo', '======END======');
	objResponse.setContentType('PLAINTEXT');
	objResponse.write(JSON.stringify(objDataResponse));
};

function _Delete(objRequest, objResponse) {
    E$.logAudit('DELETE DegreeInfo', '=====START=====');
    ...
    try {
        ...
        nlapiLogExecution('ERROR', 'Delete DegreeInfo', 'The call to get the current web session failed.:' + ex.message)
    }
    ...
    var objRxData;
	  if (stBody) {
        ...
        nlapiLogExecution('ERROR', 'Delete DegreeInfo', 'Body of the request is not defined.');
    }
    ...
    E$.logAudit('DELETE DegreeInfo', '======END======');
	objResponse.setContentType('PLAINTEXT');
	objResponse.write(JSON.stringify(objDataResponse));
};

function _Read(objRequest, objResponse) {
  E$.logAudit('READ DegreeInfo', '=====START=====');
  ...
  try {
      ...
      nlapiLogExecution('ERROR', 'Read DegreeInfo', 'The call to get the current web session failed.:' + ex.message)
  }
  ...
  E$.logAudit('READ DegreeInfo', '======END======');
	objResponse.setContentType('PLAINTEXT');
	objResponse.write(JSON.stringify(objDataResponse));
};

function _Update(objRequest, objResponse) {
  E$.logAudit("UPDATE DegreeInfo", "=====START=====");

  try {
    var objSession = nlapiGetWebContainer().getShoppingSession();
    var stCustId = objSession.getCustomer().getFieldValues().internalid;
  } catch (ex) {
    nlapiLogExecution("ERROR", "Update DegreeInfo", "The call to get the current web session failed.:" + ex.message);
  }
  ...
  if (stBody) {
    ...
    nlapiLogExecution("ERROR", "Update DegreeInfo", "Body of the request is not defined." + stBody);
  }
  ...
  E$.logAudit("UPDATE DegreeInfo", "======END======");
  objResponse.setContentType("PLAINTEXT");
  objResponse.write(JSON.stringify(objDataResponse));
};
