...
function _Check(objRequest, objResponse) {
    E$.logAudit('Check Experience', '=====START=====');
    ...
    try {
        ...
        nlapiLogExecution('ERROR', 'Check Experience', 'The call to get the current web session failed.:' + ex.message)
    }
	...
	if (stBody) {
        ...
        nlapiLogExecution('ERROR', 'Check Experience', 'Body of the request is not defined.');
    }
    ...
    E$.logAudit('Check Experience', '======END======');
...
function _Create(objRequest, objResponse) {
    E$.logAudit('Create Experience', '=====START=====');
    ...
    try {
        ...
        nlapiLogExecution('ERROR', 'Create Experience', 'The call to get the current web session failed.:' + ex.message)
    }
	...
	if (stBody) {
        ...
        nlapiLogExecution('ERROR', 'Create Experience', 'Body of the request is not defined.');
    }
    ...
    E$.logAudit('Create Experience', '======END======');
	objResponse.setContentType('PLAINTEXT');
	objResponse.write(JSON.stringify(objDataResponse));
};

function _Delete(objRequest, objResponse) {
    E$.logAudit('Delete Experience', '=====START=====');
    ...
    try {
        ...
        nlapiLogExecution('ERROR', 'Delete Experience', 'The call to get the current web session failed.:' + ex.message)
    }
	...
	if (stBody) {
        ...
        nlapiLogExecution('ERROR', 'Delete Experience', 'Body of the request is not defined.');
    }
    ...
    E$.logAudit('Delete Experience', '======END======');
	objResponse.setContentType('PLAINTEXT');
	objResponse.write(JSON.stringify(objDataResponse));
};

function _DeleteAll(objRequest, objResponse) {
    E$.logAudit('DeleteAll Experience', '=====START=====');
    ...
    try {
        ...
        nlapiLogExecution('ERROR', 'DeleteAll Experience', 'The call to get the current web session failed.:' + ex.message)
    }
	...
	if (stBody) {
        ...
        nlapiLogExecution('ERROR', 'DeleteAll Experience', 'Body of the request is not defined.');
    }
    ...
    E$.logAudit('DeleteAll Experience', '======END======');
	objResponse.setContentType('PLAINTEXT');
	objResponse.write(JSON.stringify(objDataResponse));
};
...
function _Read(objRequest, objResponse) {
    E$.logAudit('Read Experience', '=====START=====');
   ...
   try {
        ...
        nlapiLogExecution('ERROR', 'Read Experience', 'The call to get the current web session failed.:' + ex.message)
    }
	...
	if (stBody) {
        ...
        nlapiLogExecution('ERROR', 'Read Experience', 'Body of the request is not defined.');
    }
    ...
    E$.logAudit('Read Experience','Experience Return Object: ' + JSON.stringify(objDataResponse));
    E$.logAudit('Read Experience', '======END======');
	objResponse.setContentType('PLAINTEXT');
	objResponse.write(JSON.stringify(objDataResponse));
};

function _Update(objRequest, objResponse) {
    E$.logAudit('Update Experience', '=====START=====');
    ...
    try {
        ...
        nlapiLogExecution('ERROR', 'Update Experience', 'The call to get the current web session failed.:' + ex.message)
    }
	...
	if (stBody) {
        ...
        nlapiLogExecution('ERROR', 'Update Experience', 'Body of the request is not defined.');
    }
    ...
    E$.logAudit('Update Experience', '======END======');
	objResponse.setContentType('PLAINTEXT');
	objResponse.write(JSON.stringify(objDataResponse));
};
...
function _GetType(objRequest, objResponse) {
    E$.logAudit('GetType Experience', '=====START=====');

    try {
        var objSession = nlapiGetWebContainer().getShoppingSession();
        var stCustId = objSession.getCustomer();
    }
    catch (ex) {
        nlapiLogExecution('ERROR', 'GetType Experience', 'The call to get the current web session failed.:' + ex.message)
    }
	...
	if (stBody) {
        ...
        nlapiLogExecution('ERROR', 'GetType Experience', 'Body of the request is not defined.');
    }
    ...
    E$.logAudit('GetType Experience', '======END======');
	objResponse.setContentType('PLAINTEXT');
	objResponse.write(JSON.stringify(objDataResponse));
};
